...
@endsection@extends('customers/layouts/main')
              ...
              <table id="example1" class="table table-bordered table-striped dataTable dtr-inline collapsed" role="grid" aria-describedby="example1_info">
                ...
                <tbody>
                  <tr class="odd">
                    ...
                    <!-- /.button tambah -->
                    <button type="button" data-toggle="modal" data-target="#exampleModal23" class="btn  btn-sm"><i class="fa fa-pen"></i></button>
                    <a class="btn  btn-sm"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
              </tbody>

      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body text-left">
            <div <?php if (!isset($tgl_awal)): ?>
            style="display: none;"
            <?php endif ?> class="row justify-content-center">
            <div class="col-md-2">
              <img width="160px" style="border: 3px solid grey; border-radius: 50%" src="{{asset('lte/dist/img/logoBit2.png') }}" alt="User Image">
            </div>
            <div class="col-md-7 text-center">
              <?php $date = new DateTime() ?>
              <h2 class="text-danger"><strong>PT. BALI INTERNASIONAL TEKNOLOGI</strong></h2>
              <h3 class="text-primary text-uppercase"><strong>DATA PESANAN | PERIODE {{$date->format('d F Y')}}</strong></h3>
          ...
          <div class="col-sm-12 table-responsive">
            ...
            <button class="btn btn-secondary no-print" data-toggle="modal" data-target="#modal_cari_data_oder"><span>Cari Data</span>
            </button>
            <button onclick="return window.print();" class="btn btn-secondary no-print" data-toggle="modal" data-target="#modal_cari_data_oder"><span><i class="fa fa-print"></i></span>
            </button>
            ...
            <button type="button" data-toggle="modal" data-target="#exampleModal2" class="btn btn-secondary btn-sm float-right mb-2 no-print"> Tambah </button>
            <table id="example1" class="table table-bordered table-striped dataTable dtr-inline collapsed" role="grid" aria-describedby="example1_info">
              <thead>
                ...
                <th class="no-print">Bukti Pembayaran</th>
            ...
            <tbody>
              ...
              <tr class="odd">
                ...
                <a order_id="{{$o->id}}" class="btn btn-sm delete_order"><i class="fa fa-trash"></i></a>


                <!-- /.modal bayar -->
                <div class="modal fade" id="exampleModabayar{{$o->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content bg-secondary">
                      <div class="modal-header">
                        ...
                        <div class="card-body">
                          <form method="post" action="/admin_order_data/bayar/{{$o->id}}">
                            ...
                            <div class="form-group">
                              ...
                              <input required="" name="bayar" max="{{$o->remaining_payments}}" type="number" class="form-control" id="exampleInputtexto" placeholder="Input Jumlah">
                            </div>
                ...
                <!-- /.button tambah -->
                <button type="button" data-toggle="modal" data-target="#exampleModabayar{{$o->id}}" class="btn  btn-sm"><i class="fa fa-credit-card"></i></button>
              </td>
              @endforeach
            </tr>
          </tbody>
